...
- [ ] T019 [P] [US1] Crear prueba de formulario de carga de resultado en frontend/tests/integration/result-form.test.tsx
...
- [ ] T034 [P] [US3] Crear prueba de render de tabla por jornada en frontend/tests/integration/standings-page.test.tsx
...
- [ ] T041 Ejecutar suite de pruebas backend y frontend y registrar resultados en specs/001-league-standings/checklists/test-execution.md
- [ ] T042 Ejecutar validaciones de lint/format en backend/ y frontend/ y registrar estado en specs/001-league-standings/checklists/code-quality.md
- [ ] T043 Verificar cumplimiento de contrato OpenAPI contra endpoints implementados en specs/001-league-standings/contracts/standings-api.yaml
- [ ] T044 Ejecutar prueba de rendimiento de GET /standings?matchdayNumber= y registrar evidencia de cumplimiento SC-003 en specs/001-league-standings/checklists/performance.md
